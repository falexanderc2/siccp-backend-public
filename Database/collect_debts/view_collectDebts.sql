DROP VIEW IF EXISTS receibables.collect_debts_view;
CREATE VIEW receibables.collect_debts_view AS
SELECT
  A."idCollectNumber" as id,
  A."idCollectNumber"::varchar,
  ...
  to_char(A."admissionDate", 'DD/MM/YYYY HH12:MI:SS: AM') as "admissionDateQuery",
   A."admissionDate"
FROM
  receibables."collectDebts" A
order by "idCollectNumber" ASC;  
