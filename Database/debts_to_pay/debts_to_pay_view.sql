DROP VIEW IF EXISTS "debitToPay".debts_to_pay_view;
CREATE VIEW "debitToPay".debts_to_pay_view AS
SELECT 
  A."idDebtToPay" as id,
  A."idDebtToPay"::varchar,
  A."idEnterprise"::varchar,
  A."idCreditor"::varchar as "idCommon",
  A."idCreditor"::varchar,
  B."creditorName" as "commonName",
  B."creditorName",
  A."debtDescription"  ,
